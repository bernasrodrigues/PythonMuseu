...
class ChoosePage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        #self.canvas.tag_bind(self.canvas_degrade, '<Button-1>', lambda event: self.controller.show_frame( "CompPage"))  # a click anywhere on the image will go to the next page
        self.canvas.tag_bind(self.canvas_degrade, '<Button-1>', lambda event: self.clickedArea(event))  # check the area where it is clicked and goes to the next page
